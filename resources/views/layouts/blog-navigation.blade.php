        ...
        <div class="flex">
            ...
            <x-dropdown align="right" width="48">
                @auth
                    <x-slot name="trigger">
                        <button
                            ...
                            <div>{{ Auth::user()->name.' '.Auth::user()->last_name.' '.Auth::user()->id }}</div>
                ...
                @guest
                    <x-slot name="trigger">
                        <button
                            class="inline-flex items-center px-3 py-2 border border-gray-500 dark:border dark:border-gray-500 text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
